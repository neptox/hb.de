...
class WC_Amazon_Payments_Advanced {
	...
	function checkout_message() {
		if ( empty( $this->reference_id ) )
			echo '<div class="woocommerce-info info"><div id="pay_with_amazon"></div> ' . apply_filters( 'woocommerce_amazon_pa_checkout_message', __( 'Haben Sie einen Amazon-Account?', 'woocommerce-gateway-amazon-payments-advanced' ) ) . '</div>';
	}
