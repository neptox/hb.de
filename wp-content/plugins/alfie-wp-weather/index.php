...
function load_alfie_wp_weather() {
    ...
    define ('ALFIE_WEATHER_CLIENT_IP', $_SERVER['REMOTE_ADDR'] );
    define( 'ALFIE_WEATHER_DEBUG', false );

    // Make plugin translatable
    $domain = 'alfie_wp_weather';
    $locale = apply_filters( 'plugin_locale', get_locale(), $domain );
    load_textdomain( 'alfie_wp_weather', dirname( plugin_basename( __FILE__ ) ) . '/lang/' . $domain . '-' . $locale . '.mo' );
