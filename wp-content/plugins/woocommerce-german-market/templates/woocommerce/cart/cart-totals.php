...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
    ...
    <table cellspacing="0">
        ...
        <?php if( get_option( WGM_Helper::get_wgm_option( 'woocommerce_de_kleinunternehmerregelung' ) ) == 'off' ): ?>
        ...
        <?php do_action( 'woocommerce_cart_totals_before_order_t
    ...
    <?php if ( WC()->cart->get_cart_tax() && get_option( 'woocommerce_de_estimate_cart', 'on' ) === 'on' ) : ?>
        <p><small><?php
