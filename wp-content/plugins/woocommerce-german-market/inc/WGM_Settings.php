...
Class WGM_Settings {
	...
	*/
	private static function settings_de_content() {
		...
		$options_settings_hints = array(
			...
			array(
				'name' => __( 'Hinweistext auf letzer Checkoutseite', Woocommerce_German_Market::get_textdomain() ),
				'desc' => __( 'Hier können Sie Ihre Hinweise auf der letzen Checkoutseite eintragen wie zum Beispiel eventuell anfallende Kosten durch Zölle oder Nachnahmegebühren.', Woocommerce_German_Market::get_textdomain() ),
				'tip'  => __( 'Hier können Sie Ihre Hinweise auf der letzen Checkoutseite eintragen wie zum Beispiel eventuell anfallende Kosten durch Zölle oder Nachnahmegebühren.', Woocommerce_German_Market::get_textdomain() ),
	...
	*/
	public static function unforce_ssl_checkout() {
		...
		if ( $post->post_content == '[woocommerce_de_check]' ) {
			return false;
		} else {
			return true;
		}
