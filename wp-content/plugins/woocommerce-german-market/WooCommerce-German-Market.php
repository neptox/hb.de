...
class Woocommerce_German_Market {
	...
	*/
    ...
    public function __construct () {
        ...
        add_filter( 'woocommerce_before_calculate_totals',			            array( 'WGM_Template', 'add_gateway_fees' ) );
		...
		add_filter( 'woocommerce_calculate_totals',								array( 'WGM_Cash_On_Delivery', 'modify_totals' ), 10, 1 );
