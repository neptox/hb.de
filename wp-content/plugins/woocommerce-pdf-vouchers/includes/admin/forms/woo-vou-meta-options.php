...
$bg_pattern_css = $bg_image_css = 'woo-vou-meta-display-none';
...
wp_nonce_field( WOO_VOU_PLUGIN_BASENAME, 'at_woo_vou_meta_box_nonce' );
	...
	woo_vou_content_begin();
		...
		woo_vou_add_select( array( 'id' => $prefix . 'pdf_view', 'class' => 'regular-text', 'name'=> __( 'View:', 'woovoucher' ), 'options' => array( 'land' => __( 'Landscape', 'woovoucher' ), 'port' => __( 'Portrait', 'woovoucher' ) ), 'desc' => __( 'Select voucher pdf view in landscape or portrait.', 'woovoucher' ) ) );
	
		// voucher margin top
		woo_vou_add_text( array( 'id' => $prefix . 'pdf_margin_top', 'class' => 'small-text', 'name'=> __( 'Margin Top:', 'woovoucher' ), 'desc' => __( 'Enter the margin top for the PDF, please set margin in pixel.', 'woovoucher' ) ) );
	
		// voucher margin left
		woo_vou_add_text( array( 'id' => $prefix . 'pdf_margin_left', 'class' => 'small-text', 'name'=> __( 'Margin Left:', 'woovoucher' ), 'desc' => __( 'Enter the margin left for the PDF, please set margin in pixel.', 'woovoucher' ) ) );
	
		// voucher margin right
		woo_vou_add_text( array( 'id' => $prefix . 'pdf_margin_right', 'class' => 'small-text', 'name'=> __( 'Margin Right:', 'woovoucher' ), 'desc' => __( 'Enter the margin right for the PDF, please set margin in pixel.', 'woovoucher' ) ) );
