...
<div class="wrap">
    ...
    <h2><?php _e( 'Check Voucher Code', 'woovoucher' ); ?></h2>
		...
		<div class="metabox-holder">	
			...
			<div class="meta-box-sortables ui-sortable">
				...
				<div id="woo_vou_check_voucher_code_container" class="postbox">	
					...
					<div class="handlediv" title="<?php _e( 'Click to toggle', 'woovoucher' ); ?>"><br /></div>
	
					<!-- settings box title -->

					<h3 class="hndle">

						<span><?php _e( 'Check Voucher Code', 'woovoucher' ); ?></span>
